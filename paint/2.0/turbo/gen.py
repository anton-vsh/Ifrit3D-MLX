...
def main():
    ...
    parser.add_argument("--output", default="output_20_turbo_pytorch.glb")
    args = parser.parse_args()

    print("Loading 2.0 TURBO with PyTorch backend...")
    ...
    print(f"Painting {args.mesh} using {args.image} (2.0 turbo PyTorch)...")
    t0 = time.time()
