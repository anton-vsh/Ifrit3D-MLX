...
def main():
    ...
    parser.add_argument("--output", default="output_21_pytorch.glb")
    args = parser.parse_args()

    print(f"Loading 2.1 PBR with PyTorch (MPS) backend...")
    ...
    print(f"Painting {args.mesh} using {args.image} (2.1 PyTorch)...")
    t0 = time.time()
